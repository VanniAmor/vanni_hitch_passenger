...
axios.interceptors.request.use( config => {
	if(localStorage.getItem('token_passenger')){
		config.headers['Authorization'] = localStorage.getItem('token_passenger')
	}
	config.headers['Accept'] = "application/vnd.lumen.passenger+json"
	return config;
}, error => {
	console.log(error)
...
axios.interceptors.response.use((response) => {
	...
	if (token) {
		...
		localStorage.setItem('token_passenger',token)
	} 
	return response
}, (error) => {
